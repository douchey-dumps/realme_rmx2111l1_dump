...
cat system/system/priv-app/KeKeThemeStore/KeKeThemeStore.apk.* 2>/dev/null >> system/system/priv-app/KeKeThemeStore/KeKeThemeStore.apk
rm -f system/system/priv-app/KeKeThemeStore/KeKeThemeStore.apk.* 2>/dev/null
